...
ggsave("../raw_fig/FigureS8_dhs_rug.pdf", rug, "pdf", width=5, height=4, dpi=300)
ggsave("../raw_fig/FigureS8_dhs_rug_agg.pdf", rug_agg, "pdf", width=5, height=4, dpi=300)
ggsave("../raw_fig/FigureS8_dhs_point.pdf", point, "pdf", width=5, height=5, dpi=300)
ggsave("../raw_fig/FigureS8_dhs_point_agg.pdf", point_agg, "pdf", width=5, height=5, dpi=300)
...
ggsave("../raw_fig/FigureS8_diff_rug.pdf", rug, "pdf", width=5, height=4, dpi=300)
ggsave("../raw_fig/FigureS8_diff_rug_agg.pdf", rug_agg, "pdf", width=5, height=4, dpi=300)
ggsave("../raw_fig/FigureS8_diff_point.pdf", point, "pdf", width=5, height=5, dpi=300)
ggsave("../raw_fig/FigureS8_diff_point_agg.pdf", point_agg, "pdf", width=5, height=5, dpi=300)
